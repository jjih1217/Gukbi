...
public class MemberDAO {
	...
	public int setInsert(MemberDTO paramDto) {
		...
		conn = DB.dbConn();
		try {
			String sql = "insert into member (no, id, passwd, name, phone, email, jumin, juso1, juso2, juso3, juso4, grade, regiDate, attachInfo) values (seq_member.nextval, ?,?,?,?,?,?,?,?,?,?,?, sysdate, ?)";
			pstmt = conn.prepareStatement(sql);
			pstmt.setString(1, paramDto.getId());
			pstmt.setString(2, paramDto.getPasswd());
