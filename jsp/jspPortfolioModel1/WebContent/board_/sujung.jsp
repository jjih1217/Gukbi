...
<form name="DirForm">
<input type="text" name="no" id="no" value="<%=dto.getNo() %>">
<table border="1">
	<tr>
		<td>작성자</td>
		<td><%=dto.getWriter() %></td>
	...
	<tr>
		<td>공지글</td>
		<td>
		<input type="text" name="noticeNo" value="<%=dto.getNoticeNo() %>"><br>
		<% if(dto.getNoticeNo() > 0) { %>
			<input type="radio" name="noticeGubun" id="noticeGubun1" value="T" checked> 공지글 &nbsp;
			<input type="radio" name="noticeGubun" id="noticeGubun2" value="F" > 공지아님 &nbsp;
		<%  } else { %>
			<input type="radio" name="noticeGubun" id="noticeGubun1" value="T"> 공지글 &nbsp;
			<input type="radio" name="noticeGubun" id="noticeGubun2" value="F" checked> 공지아님 &nbsp;
		<% } %>
		</td>
	</tr>
	<tr>
