...
<%
	...
	if (arg1 == null || arg1.trim().equals("")) {
		...
		out.print("location.href='main.jsp?menuGubun=member2_list';"); // arg1가 없을대 arg1을 안쓰는 페이지로 이동
		out.print("</script>");
		return;
	}
	...
	if(result > 0) {
		...
		out.print("location.href='main.jsp?menuGubun=member2_view&arg1=" + arg1 + "';");
		out.print("</script>");
	} else {
		out.print("<script>");
		out.print("alert('수정처리 중 오류가 발생했습니다');");
		out.print("location.href='main.jsp?menuGubun=member2_sugung&arg1=" + arg1 + "';");
		out.print("</script>");
	}
